...
namespace BarcodeGenerator.Migrations
{
    ...
    [Migration("20251013164358_InitialCreate")]
            ...
            modelBuilder.Entity("BarcodeGenerator.Models.LabelTemplate", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BarcodeHeight = 20.0,
                            BarcodeWidth = 80.0,
                            CreatedDate = new DateTime(2025, 10, 13, 21, 43, 56, 617, DateTimeKind.Local).AddTicks(3969),
                            IsDefault = true,
                            LabelHeight = 50.0,
                            LabelWidth = 100.0,
                        ...
                        new
                        {
                            ...
                            BarcodeHeight = 15.0,
                            BarcodeWidth = 60.0,
                            CreatedDate = new DateTime(2025, 10, 13, 21, 43, 56, 619, DateTimeKind.Local).AddTicks(2733),
                            IsDefault = false,
                            LabelHeight = 25.0,
                            LabelWidth = 75.0,
                        ...
                        new
                        {
                            ...
                            BarcodeHeight = 30.0,
                            BarcodeWidth = 120.0,
                            CreatedDate = new DateTime(2025, 10, 13, 21, 43, 56, 619, DateTimeKind.Local).AddTicks(2750),
                            IsDefault = false,
                            LabelHeight = 75.0,
                            LabelWidth = 150.0,
